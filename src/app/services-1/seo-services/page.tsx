        ...
        <main ref={mainRef} className="bg-white min-h-screen overflow-x-clip font-sans">
            ...
            <section className="py-24 bg-white relative">
                <div className="container mx-auto px-6 max-w-7xl">
                    ...
                    <div className="timeline-container relative max-w-7xl mx-auto mt-20 px-4 md:px-8">
                        {/* Center Line for Desktop */}
                        <div className="hidden md:block absolute left-1/2 top-10 bottom-10 w-[2px] bg-gradient-to-b from-[#1A5CDD]/10 via-[#1A5CDD]/30 to-transparent -translate-x-1/2 rounded-full" />

                        {/* Left Line for Mobile */}
                        <div className="md:hidden absolute left-[42px] top-10 bottom-10 w-[2px] bg-gradient-to-b from-[#1A5CDD]/10 via-[#1A5CDD]/30 to-transparent -translate-x-1/2 rounded-full" />

                        <div className="space-y-12 md:space-y-6 relative z-10">
                            {onPageServicesData.map((item, index) => {
                                const isEven = index % 2 === 0;
                                return (
                                    <div key={index} className="relative w-full group">

                                        {/* Timeline Node Icon (Mobile + Desktop) */}
                                        <div className="absolute left-[42px] md:left-1/2 top-8 md:top-1/2 -translate-x-1/2 md:-translate-y-1/2 z-20">
                                            <div className="w-14 h-14 md:w-16 md:h-16 bg-[#F0F8FF] text-[#1A5CDD] rounded-[18px] md:rounded-[22px] flex items-center justify-center shadow-[0_8px_30px_rgba(26,92,221,0.15)] border-4 border-white group-hover:scale-110 group-hover:bg-[#1A5CDD] group-hover:text-white transition-all duration-500">
                                        ...
                                        <div className={`flex w-full`}>
                                            {/* Content Side (Card) */}
                                            <div className={`w-full md:w-1/2 pl-[100px] md:pl-0 ${isEven ? 'md:pr-16' : 'md:pl-16 md:ml-auto'}`}>
                                                <div className={`bg-white p-7 md:p-8 rounded-[32px] border border-slate-100 shadow-[0_8px_30px_rgba(0,0,0,0.04)] hover:shadow-[0_20px_50px_rgba(26,92,221,0.12)] transition-shadow duration-500 relative overflow-hidden text-left w-full`}>

                                                    {/* Number Background */}
                                                    <div className={`text-[#1A5CDD]/5 font-black text-6xl md:text-7xl absolute top-4 -z-10 transition-transform duration-500 group-hover:scale-110 left-6`}>
                                                        {String(index + 1).padStart(2, '0')}
                                                    </div>

                                                    <div className="relative z-10 pt-2">
                                                        <h4 className="text-[19px] md:text-xl font-extrabold text-[#011146] mb-3 group-hover:text-[#1A5CDD] transition-colors duration-300">{item.title}</h4>
            ...
            <section className="py-24 bg-slate-50 relative overflow-hidden">
                ...
                <div className="container mx-auto px-4 relative max-w-7xl">
                    ...
                    <div className="flex flex-col lg:flex-row items-center gap-10 rounded-[40px] p-4 lg:p-6 shadow-[0_8px_30px_rgba(0,0,0,0.04)] mb-20 bg-white border border-slate-100 group/hero relative overflow-hidden">
                        ...
                        {/* Right Side: Image (Unique Asymmetric Shape) */}
                        <div className="lg:w-1/2 relative z-10 flex items-center justify-center p-6 lg:p-8">
                            {/* Decorative Stacked Background Layers */}
                            <div className="absolute inset-4 bg-[#1A5CDD]/5 rounded-tl-[120px] rounded-br-[120px] rounded-tr-[30px] rounded-bl-[30px] transform rotate-3 pointer-events-none" />
                            <div className="absolute inset-4 bg-[#38bdf8]/10 rounded-tl-[120px] rounded-br-[120px] rounded-tr-[30px] rounded-bl-[30px] transform -rotate-2 pointer-events-none" />

                            {/* Main Image Container */}
                            <div className="relative overflow-hidden rounded-tl-[100px] rounded-br-[100px] rounded-tr-[24px] rounded-bl-[24px] shadow-[0_20px_50px_rgba(0,0,0,0.1)] border-[8px] border-white z-10 w-full aspect-[4/3] group/image">
                                <img src="/images/technical-seo-bright.png" alt="Technical SEO Performance" className="w-full h-full object-cover transform group-hover/image:scale-110 transition-transform duration-700" />
                ...
                <div className="container mx-auto px-4 relative max-w-7xl">
                    ...
                    <div className="flex flex-col lg:flex-row-reverse gap-16 lg:gap-20 items-center mb-20">
                        ...
                        <div className="lg:w-1/2 relative z-10">
                            ...
                            <h2 className="text-3xl md:text-4xl lg:text-5xl font-extrabold text-[#011146] mb-6 leading-tight">
                                Strengthen Your Website Authority and Build <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#1A5CDD] to-[#38bdf8]">Long-Term Organic Growth</span>
                            </h2>
                            
                            <p className="text-slate-600 text-[16px] leading-relaxed mb-5">
                                At Syscorp, our Off-Page SEO Services are designed to strengthen your website's authority, credibility, and online reputation beyond your website. As a trusted provider of SEO Services in Pondicherry, we implement strategic off-page optimization techniques that improve your brand's online presence, increase domain authority, and enhance search engine rankings through ethical White Hat SEO practices.
                            </p>
                            
                            <p className="text-slate-600 text-[16px] leading-relaxed mb-8">
                                Our Off-Page SEO solutions include brand authority building, local citation management, business directory submissions, Google Business Profile optimization, online reputation management, content outreach, social media promotion, review management, and high-quality link building strategies.
                            </p>
                            ...
                            <div className="flex flex-col sm:flex-row gap-4 mb-8">
                                <div className="flex-1 bg-[#F8FAFC] border border-slate-100 rounded-xl p-3.5 flex items-center gap-3">
                                    ...
                                    <span className="text-[#011146] font-bold text-[14px]">Ethical White Hat SEO</span>
                                </div>
                                <div className="flex-1 bg-[#F8FAFC] border border-slate-100 rounded-xl p-3.5 flex items-center gap-3">
                                    <div className="w-6 h-6 rounded-full bg-[#1A5CDD]/10 text-[#1A5CDD] flex items-center justify-center shrink-0">
                                        <CheckCircle2 size={14} strokeWidth={3} />
                                    </div>
                                    <span className="text-[#011146] font-bold text-[14px]">High-Quality Link Building</span>
                                </div>
                            </div>

                            {/* Feature Cards split from the last paragraph */}
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-5 mb-6">
                                <div className="bg-[#F8FAFC] border border-slate-100 rounded-[20px] p-6 group hover:border-[#1A5CDD]/20 hover:bg-white hover:shadow-lg transition-all duration-300">
                                    <div className="w-10 h-10 rounded-xl bg-blue-100/50 text-[#1A5CDD] flex items-center justify-center mb-4 group-hover:bg-[#1A5CDD] group-hover:text-white transition-colors">
                                        <TrendingUp size={18} strokeWidth={2.5} />
                                    </div>
                                    <h4 className="text-[#011146] font-extrabold text-[16px] mb-2">Earn Greater Trust</h4>
                                    <p className="text-slate-500 text-[13px] leading-relaxed">
                                        By combining these proven techniques, we help businesses earn greater trust from search engines, attract qualified organic traffic, and achieve sustainable long-term growth.
                                    </p>
                                </div>
                                ...
                                <div className="bg-[#F8FAFC] border border-slate-100 rounded-[20px] p-6 group hover:border-[#1A5CDD]/20 hover:bg-white hover:shadow-lg transition-all duration-300">
                                    ...
                                    <h4 className="text-[#011146] font-extrabold text-[16px] mb-2">Measurable Results</h4>
                                    <p className="text-slate-500 text-[13px] leading-relaxed">
                                        Whether you're looking to expand your digital presence or improve your search visibility, our professional SEO delivers customized off-page strategies that drive results.
                                    </p>
                                </div>
                            </div>
                        </div>
            ...
            <section className="py-24 bg-white relative overflow-hidden">
                <div className="container mx-auto px-4 relative max-w-7xl">
                    ...
                    <div className="flex flex-col lg:flex-row items-center gap-16 mb-20 bg-[#FAFCFF] rounded-[40px] p-5 lg:p-12 border border-[#1A5CDD]/10 shadow-[0_8px_30px_rgba(26,92,221,0.04)] relative overflow-hidden">
                        ...
                        <div className="lg:w-1/2 relative">
                            ...
                            <div className="relative group">
                                <div className="rounded-bl-[120px] rounded-tr-[120px] rounded-tl-[24px] rounded-br-[24px] overflow-hidden shadow-[0_20px_50px_rgba(26,92,221,0.15)] border-8 border-white bg-white">
                                ...
                                <div className="absolute -bottom-8 -right-8 bg-white/90 backdrop-blur-md p-6 rounded-[24px] shadow-xl border border-white max-w-[220px] transform group-hover:-translate-y-2 transition-transform duration-500 hidden md:block">
                                    <div className="flex items-center gap-3 mb-2">
                                        ...
                                        <span className="font-extrabold text-2xl text-[#011146]">Targeted</span>
                                    </div>
                                    <p className="text-sm font-semibold text-slate-600 leading-snug">High-Intent Keywords</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="mt-16 max-w-5xl mx-auto bg-white rounded-2xl shadow-[0_20px_60px_rgba(0,0,0,0.08)] overflow-hidden border border-slate-200">
                    ...
                    <div className="relative w-full overflow-hidden marquee-container py-4 -mx-6 px-6 lg:mx-0 lg:px-0">
                        ...
                        <div className="animate-marquee gap-4 md:gap-6">
                            {[
                                ...
                                <div key={index} className="w-[160px] md:w-[190px] flex-shrink-0 group bg-white border border-slate-200 rounded-[14px] p-4 md:p-5 flex flex-col items-center justify-center text-center hover:border-[#1A5CDD]/30 hover:shadow-[0_8px_30px_rgba(26,92,221,0.06)] transition-all duration-300 hover:-translate-y-1 cursor-default">
                                    <div className={`w-14 h-14 rounded-full flex items-center justify-center mb-3 md:mb-4 group-hover:text-white group-hover:scale-110 transition-all duration-500 shadow-sm border ${item.color}`}>
                                        <item.icon size={24} strokeWidth={2} />
                                    </div>
                                    <h3 className="text-[13px] md:text-[14px] font-bold text-[#011146] group-hover:text-[#1A5CDD] transition-colors duration-300 leading-snug">
                                        {item.title}
                                    </h3>
                                </div>
                            ))}

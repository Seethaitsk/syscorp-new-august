                ...
                <div className="container mx-auto px-6 max-w-7xl relative z-10">
                    <div className="text-center max-w-4xl mx-auto mb-16">
                        <div className="inline-flex items-center justify-center mb-6 relative group">
                            ...
                            <span className="relative px-5 py-1.5 rounded-full bg-white/5 backdrop-blur-md border border-white/20 text-[#38bdf8] text-[13px] font-extrabold tracking-widest uppercase shadow-sm flex items-center gap-2">

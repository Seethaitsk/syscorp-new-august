        ...
        <section ref={sectionRef} className="relative py-32 bg-[#f8fafc] dark:bg-[#020617] overflow-hidden">
            ...
            <div className="container mx-auto px-6 max-w-[1280px] relative z-10">
                ...
                <div className="text-center max-w-4xl mx-auto mb-20 flex flex-col items-center">
                    ...
                    <h2 className="ai-reveal text-4xl md:text-5xl lg:text-6xl font-extrabold text-slate-900 dark:text-white leading-[1.1] tracking-tight mb-8">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-10 items-stretch">
                    ...
                    <div className="ai-reveal relative rounded-[2rem] overflow-hidden min-h-[500px] h-full bg-slate-900 dark:bg-[#030712] border border-slate-800 dark:border-white/10 group shadow-[0_15px_40px_rgba(0,0,0,0.08)]">
                        ...
                        <div className="absolute bottom-6 left-6 p-4 rounded-2xl bg-white/95 dark:bg-slate-900/95 backdrop-blur-xl border border-white/20 dark:border-white/10 shadow-2xl flex items-center gap-4 transform translate-y-2 group-hover:translate-y-0 group-hover:rotate-[-2deg] transition-all duration-500 ease-out">
                            <div className="w-12 h-12 rounded-[14px] bg-emerald-50 dark:bg-emerald-500/10 flex items-center justify-center text-emerald-600 dark:text-emerald-400">
                                <Zap className="w-6 h-6" />
                            </div>
                            <div>
                                <p className="text-[11px] font-bold text-slate-500 dark:text-slate-400 uppercase tracking-widest leading-none mb-1.5">Live Efficiency</p>
                                <p className="text-[19px] font-black text-slate-900 dark:text-white leading-none tracking-tight">99.8% Perfect</p>
                            </div>
                        </div>

                        {/* Floating Tech Badge (Top Tier Tech Partner) */}
                        <div className="absolute bottom-6 right-6 bg-slate-900/90 dark:bg-black/80 backdrop-blur-xl border border-slate-700 dark:border-white/10 rounded-2xl p-4 flex items-center gap-4 shadow-2xl transform translate-y-2 group-hover:translate-y-0 group-hover:rotate-[2deg] transition-all duration-500 ease-out delay-75">
                            <div className="w-12 h-12 rounded-full bg-gradient-to-br from-blue-500 to-indigo-600 flex items-center justify-center text-white relative shrink-0">
                                <Sparkles className="w-5 h-5 relative z-10" />
                                <div className="absolute inset-0 rounded-full bg-blue-400/50 blur-md animate-pulse" />
                            </div>
                            <div>
                                <p className="text-[18px] font-black text-white leading-none tracking-tight mb-1">Top Tier</p>
                                <p className="text-[10px] font-bold text-blue-300 uppercase tracking-widest m-0">Tech Partner</p>
                            </div>
                        </div>
                    </div>

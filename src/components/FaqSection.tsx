...
export default function FAQSection() {
  ...
  return (
    <section
      ...
      className="relative bg-white dark:bg-slate-950 py-8 md:py-10 lg:py-12 overflow-hidden transition-colors duration-300"
    >
                ...
                >
                  ...
                  >
                    ...
                    <div className="flex-shrink-0 ml-4">
                      <svg className={`w-5 h-5 transition-all duration-300 ${isOpen ? "text-[#1A5CDD] dark:text-[#60A5FA] rotate-180" : "text-gray-500 dark:text-gray-400 group-hover:text-[#1A5CDD] dark:group-hover:text-[#60A5FA] rotate-0"}`} fill="none" stroke="currentColor" strokeWidth="2.5" viewBox="0 0 24 24">

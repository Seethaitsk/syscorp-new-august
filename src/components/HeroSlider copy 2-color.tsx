    ...
    <div ref={containerRef}>
      <style>{`
        ...
        .sky-banner-btn-primary {
          ...
          box-shadow: 0 10px 30px rgba(26, 92, 221, 0.25);
        }
        ...
        .sky-prev-card:hover {
          ...
          box-shadow: 0 25px 50px rgba(26, 92, 221, 0.25);
        }
      ...
      {/* ─── BANNER CONTAINER (SYSCORP ROYAL BLUE & ELECTRIC CYAN THEME) ─── */}
      <section id="home-banner" className="sky-banner-sec bg-[#02091d] relative overflow-hidden text-white">

        {/* Diagonal Luminous Spotlight Beam (Top Right to Bottom Left in Royal Blue & Cyan) */}
        <div className="absolute -top-40 -right-20 w-[1100px] h-[750px] bg-gradient-to-bl from-sky-400/25 via-blue-600/25 via-[#1A5CDD]/20 to-transparent rotate-[-30deg] scale-125 blur-[95px] pointer-events-none" />

        {/* Ambient Glow Orbs */}
        <div className="absolute top-10 right-1/4 w-[600px] h-[600px] bg-[#1A5CDD]/20 rounded-full blur-[160px] pointer-events-none" />
        <div className="absolute bottom-10 left-10 w-[500px] h-[500px] bg-sky-500/15 rounded-full blur-[140px] pointer-events-none" />

        {/* Background Grid Pattern with Cyan Starlight Dots */}
        <div className="absolute inset-0 bg-[radial-gradient(rgba(56,189,248,0.15)_1px,transparent_1px)] [background-size:24px_24px] pointer-events-none" />
        <div className="absolute inset-0 bg-[linear-gradient(135deg,rgba(255,255,255,0.03)_1px,transparent_1px)] [background-size:40px_40px] pointer-events-none opacity-40" />

        {/* Concentric Orbits & Icons Background */}
        <div className="absolute inset-0 pointer-events-none overflow-hidden z-0 flex items-center justify-center">
          {/* SVG Orbits */}
          <svg width="100%" height="100%" className="absolute min-w-[1400px] min-h-[1400px] opacity-20" viewBox="0 0 1000 1000" fill="none">
            <circle cx="500" cy="500" r="240" stroke="rgba(56,189,248,0.2)" strokeWidth="1.5" strokeDasharray="6 6" />
            <circle cx="500" cy="500" r="380" stroke="rgba(56,189,248,0.2)" strokeWidth="1.5" strokeDasharray="6 6" />
            <circle cx="500" cy="500" r="520" stroke="rgba(56,189,248,0.2)" strokeWidth="1.5" strokeDasharray="6 6" />
            <circle cx="500" cy="500" r="660" stroke="rgba(56,189,248,0.2)" strokeWidth="1.5" strokeDasharray="6 6" />
          </svg>

          {/* Floating Web-Development Related Icons */}
          {/* 1. Code Brackets Icon (Web Dev) */}
          <div className="sky-orbit-icon-wrap" style={{ left: "5%", top: "20%", animationDelay: "0s", animationDuration: "5s" }} title="Web Coding & Development">
          ...
          {/* 2. Global Web Domain Icon (WWW / Globe) */}
          <div className="sky-orbit-icon-wrap" style={{ right: "5%", top: "18%", animationDelay: "1s", animationDuration: "6s" }} title="Global Web Domain">
          ...
          {/* 3. React / Web Framework Icon */}
          <div className="sky-orbit-icon-wrap" style={{ left: "15%", top: "34%", animationDelay: "0.5s", animationDuration: "5.5s" }} title="Next.js / React Framework">
          ...
          {/* 4. Responsive Web Screen & Layout Icon */}
          <div className="sky-orbit-icon-wrap" style={{ right: "15%", top: "32%", animationDelay: "2.5s", animationDuration: "6.2s" }} title="Responsive Web Design">
          ...
          {/* 5. Cloud Hosting & Server Icon */}
          <div className="sky-orbit-icon-wrap" style={{ left: "8%", top: "56%", animationDelay: "2s", animationDuration: "5.8s" }} title="Cloud Hosting & DevOps">
          ...
          {/* 6. Database / Backend Storage Icon */}
          <div className="sky-orbit-icon-wrap" style={{ right: "8%", top: "54%", animationDelay: "3s", animationDuration: "6.5s" }} title="Database & Backend API">
          ...
          {/* 7. SSL Security & Web Shield Icon */}
          <div className="sky-orbit-icon-wrap" style={{ left: "14%", top: "76%", animationDelay: "1.5s", animationDuration: "4.8s" }} title="SSL Security & Protection">
          ...
          {/* 8. Mobile App / Responsive Mobile Icon */}
          <div className="sky-orbit-icon-wrap" style={{ right: "14%", top: "74%", animationDelay: "3.5s", animationDuration: "5.6s" }} title="Mobile Web & PWA">
        ...
        <div style={{ position: "relative", zIndex: 5, display: "flex", flexDirection: "column", alignItems: "center", padding: "0 24px" }}>
          ...
          <h1 className="sky-banner-heading">
            ...
            <br />
            To Automate <span className="inline-block transition-colors duration-300" style={{ color: colors[wordIndex] }}>{typedText}</span>
            <span className="animate-pulse" style={{ color: colors[wordIndex] }}>|</span>
          </h1>

          {/* Subtext */}
          <p className="sky-banner-sub">
            Comprehensive AI & software solutions for businesses, from machine learning models to intelligent automation systems that revolutionize how you work.
          </p>

          {/* Buttons */}
          <div className="sky-banner-ctas">
            <a href="/contact" className="sky-banner-btn-primary">
              Get Started
            </a>
          ...
          {/* Star Rating Line */}
          <div className="flex flex-wrap items-center justify-center gap-2 text-xs sm:text-sm text-slate-300 mb-8">
            <span className="text-[#38bdf8] font-bold text-base tracking-widest">★★★★★</span>
            <span className="font-bold text-white">4.8</span>
            <span className="text-slate-400">/5.0 Based On 4,563 Reviews • GDPR Compliant</span>
          </div>
                  ...
                  return (
                    <div key={idx} className="w-full md:w-1/2 lg:w-1/3 flex-shrink-0 px-3">
                      <div className="sky-prev-card group hover:border-blue-500/30 hover:shadow-[0_20px_40px_rgba(59,130,246,0.12)] sky-dotted-grid min-h-[300px]">
                        ...
                        <p className="text-[11.5px] text-slate-300 m-0 mb-4 relative z-10">High-conversion landing pages & apps</p>
                  ...
                  return (
                    <div key={idx} className="w-full md:w-1/2 lg:w-1/3 flex-shrink-0 px-3">
                      <div className="sky-prev-card group hover:border-emerald-500/30 hover:shadow-[0_20px_40px_rgba(16,185,129,0.12)] sky-dotted-grid min-h-[300px]">
                        ...
                        <p className="text-[11.5px] text-slate-300 m-0 mb-4 relative z-10">Accelerating pipelines & updates</p>
                  ...
                  return (
                    <div key={idx} className="w-full md:w-1/2 lg:w-1/3 flex-shrink-0 px-3">
                      <div className="sky-prev-card group hover:border-purple-500/30 hover:shadow-[0_20px_40px_rgba(168,85,247,0.12)] sky-dotted-grid min-h-[300px]">
                        ...
                        <p className="text-[11.5px] text-slate-300 m-0 mb-4 relative z-10">First-page Google presence</p>
                  ...
                  return (
                    <div key={idx} className="w-full md:w-1/2 lg:w-1/3 flex-shrink-0 px-3">
                      <div className="sky-prev-card group hover:border-sky-500/30 hover:shadow-[0_20px_40px_rgba(56,189,248,0.12)] sky-dotted-grid min-h-[300px]">
                        ...
                        <p className="text-[11.5px] text-slate-300 m-0 mb-4 relative z-10">High-availability hosting & security</p>
